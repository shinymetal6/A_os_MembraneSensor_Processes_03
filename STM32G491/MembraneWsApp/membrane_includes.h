...
#define		APP_NAME				"Membrane-WSensor_02"
...
#define	ADC1_ANALOG_INDEX			1
#define	ADC1_VREFINT_INDEX			2
#define	ADC1_TEMPERATURE_INDEX		3

#define	NUM_ADC2_CHANNELS			2
#define	ADC2_CALIBRATION_INDEX		0
#define	ADC2_UNUSED_INDEX			0

#define	ADC_STATE_IDLE				0
#define	ADC_NOISE_STATE_ACQUISITION	1
#define	ADC_STATE_ACQUISITION		2
#define	ADC_STATE_CYCLE_END			3

#define	ADC_NOISE_ACQUISITION_CYCLES	64
#define	ADC_NUM_ACQUISITION_CYCLES		128
#define	ADC_ACQUISITION_OFFSET			4
#define	ADC_TOTAL_CYCLES				(ADC_NOISE_ACQUISITION_CYCLES +  ADC_NUM_ACQUISITION_CYCLES + ADC_ACQUISITION_OFFSET)

#define	DAC_MAX_VALUE				4095
#define	DAC_THRESHOLDLOW_VALUE		512
#define	DAC_THRESHOLDHIGH_VALUE		3500
//#define	DAC_OUT_VALUE				(DAC_MAX_VALUE - (DAC_MAX_VALUE / 4))
//#define	DAC_OUT_VALUE				(DAC_MAX_VALUE / 2)
#define	DAC_OUT_VALUE				DAC_MAX_VALUE
